...
public class ScoreTest extends TestCase {
  ...
  public void testSimple() throws Exception {
    ...
    indexSingleFieldDocs(new Field[] {new Field("contents", "x x y z", textType)});
    indexSingleFieldDocs(new Field[] {new Field("contents", "x a b", textType)});
    indexSingleFieldDocs(new Field[] {new Field("contents", "a c d", textType)});
    ...
    for (int i = 0 ; i < matches.totalHits;i ++) {
      System.out.println(i + ": " + matches.scoreDocs[i].score);
    }
